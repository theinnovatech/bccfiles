                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #a8b8d4; box-shadow: 0 4px 24px rgba(0, 42, 122, 0.08);">
                    ...
                    <tr>
                        <td style="padding: 36px 40px 28px;">
                            <p style="margin: 0 0 8px; font-size: 15px; color: #4a6490; font-weight: 500;">Welcome,</p>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 10px 0; border-bottom: 1px solid #c5d0e8;">
                                                    <span style="display: block; font-size: 12px; color: #4a6490; margin-bottom: 4px;">Login Email</span>
                                                    <span style="font-size: 15px; font-weight: 600; color: #00164d;">{{ $loginEmail }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 10px 0;">
                                                    <span style="display: block; font-size: 12px; color: #4a6490; margin-bottom: 4px;">Password</span>
                                                    <span style="font-size: 15px; font-weight: 600; color: #00164d; font-family: 'Courier New', Courier, monospace; background: #ffffff; padding: 6px 10px; border-radius: 6px; border: 1px solid #a8b8d4; display: inline-block;">{{ $plainPassword }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #fffbeb; border: 1px solid #fcd116; border-radius: 8px; margin-bottom: 28px;">
                                <tr>
                                    <td style="padding: 14px 18px;">
                                        <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #000f33;">
                                            <strong style="color: #00164d;">Security tip:</strong> Please log in and change your password as soon as possible. Do not share these credentials with anyone.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 8px;">
                                        <a href="{{ $appUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #001f6b 0%, #00164d 100%); color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; padding: 14px 36px; border-radius: 8px; box-shadow: 0 4px 12px rgba(0, 56, 168, 0.35);">
                                            Log In to {{ $appName }}
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="background-color: #e2e8f2; border-top: 1px solid #a8b8d4; padding: 24px 40px; text-align: center;">
                            <p style="margin: 0 0 6px; font-size: 13px; color: #4a6490;">
