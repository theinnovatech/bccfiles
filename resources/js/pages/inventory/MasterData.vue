    ...
    <div class="space-y-6">
        <div class="shadcn-card overflow-hidden">
            <div class="stock-op-hero border-b border-[#c8d6ef] px-4 py-5 sm:px-6">
                <h3 class="text-lg font-semibold text-[#002a7a]">Master Data</h3>
                <p class="mt-1 text-sm text-[#5b7fbf]">
                    Manage item categories, equipment categories, units of measure, and storage locations.
                </p>
            ...
            <div class="stock-op-content p-4 sm:p-6">
                ...
                <EquipmentCategories v-else-if="activeTab === 'equipment-categories'" embedded />
...
const IconCategories = () =>
    h('svg', { fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '2' }, [
        h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z' }),
    ]);

const IconUnits = () =>
    h('svg', { fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '2' }, [
        h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m0 0v12m0-12v-2.25m0 2.25h10.5M7.5 18h10.5M7.5 18v-2.25m0 2.25H3.75' }),
    ]);
...
const tabs = [
    { key: 'categories', label: 'Item Categories', description: 'Group inventory items by type', icon: IconCategories },
    { key: 'equipment-categories', label: 'Equipment Categories', description: 'Categories used when registering equipment', icon: IconEquipmentCategories },
    { key: 'units', label: 'Units', description: 'Define units of measure', icon: IconUnits },
    { key: 'locations', label: 'Locations', description: 'Storage areas and shelves', icon: IconLocations },
];
